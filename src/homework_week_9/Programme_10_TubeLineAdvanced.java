...
public class Programme_10_TubeLineAdvanced {
    public static void main(String[] args) {
        ...
        do {
            //JFrame and JOption is used for display Dialog and take input from user
            ...
            b = JOptionPane.showInputDialog(frame, "Do you want to again then please Y", "Press Y or N", JOptionPane.WARNING_MESSAGE).toLowerCase();
        } while (b.equals("y"));
        System.exit(0);
    }
}
