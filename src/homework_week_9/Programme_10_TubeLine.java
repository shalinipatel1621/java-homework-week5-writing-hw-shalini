...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angel", "Baker Street", "Bank", "Barbican",
                ...
                "Covent Garden", "Earls Court", "Edgware Road", "Elephant & Castle", "Embankment", "Euston", "Euston Sqaure",
                "Farringdon", "Gloucester Road", "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington",
                "Holborn", "Hyde Park Corner", "Kings Cross", "Knightsbridge", "Lambeth North", "Lancaster Gate",
                "Leicester Square", "Liverpool Street", "London Bridge", "Mansion House", "Marble Arch", "Marylebone", "Monument",
                "Moorgate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington", "Picaddily Circus", "Pimlico",
                "Queensway", "Regents Park", "Russell Sqaure", "Sloane Sqaure", "South Kensington", "St Pancras", "St Paul's",
        ...
        londonUGLines[0][4] = "Elephant and Castle"; //Station name
        ...
        londonUGLines[0][9] = "Regents Park"; //Station name
        ...
        londonUGLines[3][6] = "Cannons Street";
        londonUGLines[3][7] = "Earls Court";
        ...
        londonUGLines[7][11] = "Kings Cross";
        ...
        System.out.println("Please enter the tube stations name of Zone 1: ");
        ...
        //Check, if user input is present in the list of zone 1 stations
